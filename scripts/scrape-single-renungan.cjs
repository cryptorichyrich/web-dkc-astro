...
(async () => {
    const postUrl = 'https://www.mirifica.net/bacaan-mazmur-tanggapan-dan-renungan-harian-katolik-sabtu-6-juni-2026/';
    ...
    // Parse date from title (more reliable than datetime attr which has TZ issues)
    ...
    // Use project root, not __dirname (which is scripts/)
