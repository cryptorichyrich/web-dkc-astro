...
Are goodness and being the same really? Granted that they differ only in idea, which is prior in thought? Granted that being is prior, is every being good? To what cause should goodness be reduced? Does goodness consist in mode, species, and order? Is goodness divided into the virtuous, the useful, and the pleasant?
